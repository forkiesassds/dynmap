package org.dynmap.bukkit.helper.v121_1;

import net.minecraft.world.level.biome.BiomeBase;
import net.minecraft.world.level.biome.BiomeFog;
import org.bukkit.World;
// Please check that line bellow idk if it's fine
 ...
 */
public class MapChunkCache121_1 extends GenericMapChunkCache {
    private static final AsyncChunkProvider121_1 provider = BukkitVersionHelper.helper.isUnsafeAsync() ? null : new AsyncChunkProvider121_1();
    private World w;
    /**
     * Construct empty cache
     */
    public MapChunkCache121_1(GenericChunkCache cc) {
        super(cc);
    }
